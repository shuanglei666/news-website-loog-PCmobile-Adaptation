<template>
    ...
    <div class="Mytitle">
        <!-- PC layout -->
        <div class="Mytitle_pc">
            <div class="main_box">
                <div class="logo">
                    <img :src="logos[logoIndex]" @click="logoClick"/>
                </div>
                <div class="list_box">
                    <div v-for="(item,index) in title_list" :key="item.id" :value='item.title' @click="jump(index)"
                        class="list1" :class="{list2:index == num}">
                        {{item.title}}
                    </div>
                </div>
                <div class="iconList">
                    <!-- <div class="image1">
                        <img src="../../assets/images2/wallet.png" alt="">
                    </div>
                    <div class="image2">
                        <img src="../../assets/images2/User.png" alt="">
                    </div> -->
                    <!-- 语言加margin-left 加登录去掉 -->
                    <div class="languag" >
                        <div :class="flag? 'langSpan1' : 'langSpan2'" @click="getLang('zh-cn')">{{$t('Home2.Mytitle.CN')}}
                        </div>
                        <span> / </span>
                        <div :class="!flag? 'langSpan1' : 'langSpan2'" @click="getLang('en-us')">EN</div>
                    </div>
...
export default {
    data () {
        return {
            ...
            typeId: 0,
			logos: [
				require('@/assets/images/logos/0.png'),
				require('@/assets/images/logos/01.png'),
				require('@/assets/images/logos/02.png'),
				require('@/assets/images/logos/03.png'),
				require('@/assets/images/logos/04.png'),
				require('@/assets/images/logos/05.png'),
				require('@/assets/images/logos/06.png'),
				require('@/assets/images/logos/07.png'),
				require('@/assets/images/logos/08.png'),
				require('@/assets/images/logos/09.png'),
			],
			logoIndex: 4,
			scrollItems: [],
        };
    ...
    methods: {
		...
		getAllScrollItem() {
			...
			for(let i in elements) {
				if(elements[i].className == 'scroll-item') {
					this.scrollItems.push(elements[i])
				}
			}
    ...
    mounted () {
		this.getAllScrollItem()
		
        this.typeId = Number(window.name)
        this.num = Number(window.name)
        this.jump(this.typeId)
        ...
        window.addEventListener("scroll", () => {
			...
			for(let i in this.scrollItems) {
				if(this.top + offset >= this.scrollItems[i].offsetTop && this.top + offset < (this.scrollItems[i].offsetTop + this.scrollItems[i].offsetHeight)) {
					this.num = i
				}
			}
        ...
        .main_media {
            ...
            .main_media_right {
                ...
                .main_media_right_right {
                    ...
                    margin-right: 30px;
                    // margin-right: 40px;
                    background-image: url(../../assets/images2/wallet.png);
                    background-size: 100% 100%;
                    background-repeat: no-repeat;
                    // pointer-events: none;
                }
                .main_media_right_left {
                    width: 28px;
                    height: 18px;
                    background-image: url(../../assets/images2/three.png);
                    background-size: 100% 100%;
                    background-repeat: no-repeat;
                    // border: 1px solid red;
                    overflow: hidden;
