    ...
    <div class="max">
      ...
      <div class="header_bottom">
        <Mytitle></Mytitle>
                ...
                <Mytitle class="Mytitle_bdr" @myEven="getNum"></Mytitle>
                <!-- <Mytitlebdr></Mytitlebdr> -->
            </div>
            <div class="content">
                <Onemain></Onemain>
                <Twomain></Twomain>
...
<script>
import $ from 'jquery'
import Myhead from "../components2/Myhead/Myhead.vue";
import Mytitlebdr from "../components2/MYcircular/Mytitlebdr.vue";
import Mytitle from "../components2/title/Mytitle.vue";
import Onemain from "../components2/Mymain/Onemain.vue";
import Twomain from "../components2/Mymain/Twomain.vue";
import mycircularright from "../components2/MYcircular/mycircularright.vue";
import Theremain from "../components2/Mymain/Theremain.vue";
import mycircularleft from "../components2/MYcircular/mycircularleft.vue";
import Fourmain from "../components2/Mymain/Fourmain.vue";
import Fivemain from "../components2/Mymain/Fivemain.vue";
import Sixmain from "../components2/Mymain/Sixmain.vue";
import Sevenmain from "../components2/Mymain/Sevenmain.vue";
import Myfooter from "../components2/Myfooter/Myfooter.vue"
export default {
    name: "Home",
    data () {
        return {
    ...
    created () {
        ...
        // var afterEqual = afterUrl.substring(afterUrl.indexOf('=') + 1).toLowerCase();
        // console.log(afterEqual, '地址');
